                            ...
                            .then(data => {
                                if (data.insertedId) {
                                    ...
                                    Swal.fire({
                                        position: 'top-end',
                                        icon: 'success',
                                        title: 'User create a successfully',
                    ...
                    <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                        <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                            ...
                            <div className="form-control">
                                ...
                                {errors.password?.type === 'pattern' && <p className="text-red-600">password must be one uppercase one lower case one number one special character</p>}
